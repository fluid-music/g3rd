...
module.exports = {
  ...
  infoStretched,
  tLibrary : {
    a: new G3(info10ths['A2-min-001.wav'], infoStretched['01-A2-min-003-stretch.wav'], [45, 45 + 15], { onset: 0, release: 8.09 }),
    ...
    h: new G3(info10ths['A3-min-001.wav'], infoStretched['08-A3-min-004-stretch.wav'], [57, 57 + 15], { onset: 0.6, release: 6.29 }),
